        ...
        {isLoggedIn() && (
          <div>
            ...
            <List>
              <ListItem
                component={Link}
                onClick={this.navToRoute(`/user/${getUserId()}`)}
              >
                <ListItemIcon>
                  <Person />
                </ListItemIcon>
          ...
          <Toolbar>
            ...
            {isLoggedIn() ? (
              <Hidden smDown implementation="css">
                ...
                <Button
                  onClick={this.navToRoute('/messages')}
                  className={classes.navButton}
                  color="inherit"
                >
                  Message
...
export default connect(mapStateToProps)(
  withStyles(styles, { withTheme: true })(withRouter(NavigationBar))
);
